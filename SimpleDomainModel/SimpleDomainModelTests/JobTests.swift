...
class JobTests: XCTestCase {
  ...
  func testHourlyRaise() {
    ...
    func hourlyJobTest() {
        let job = Job(title: "Barista", type: Job.JobType.Hourly(15))
        XCTAssert(job.description == "Barista: $15.0 per hour")
    }
    
    func salaryJobTest() {
        let job = Job(title: "Teacher", type: Job.JobType.Salary(50000))
        XCTAssert(job.description == "Teacher: $5000.0 per year")
    }
